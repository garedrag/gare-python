...
z = []
print z
if month_birthday in ['January','February','March','April','May']:#,'June','February','July','August','January','September','October','November','December']):# and birthday in range(1,31):
